...
Rails.application.config.sorcery.configure do |config|
  ...
  #
  config.facebook.key = "246629502097443"
  config.facebook.secret = "a0947d1392a998c3349d73a8f0ba1f67"
  config.facebook.callback_url = "http://localhost:3000/oauth/callback?provider=facebook"
  # config.facebook.user_info_mapping = {:email => "name"}
  config.facebook.user_info_mapping = {:email => "email", :name => "name" ,:username => "username", :avatar => "avatar",:hometown => "hometown/name"}
